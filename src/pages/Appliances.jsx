...
const appliancesData = [
    {
        ...
        rating: 4.4,
        reviews: 5200,
        specs: ['4K Ultra HD', 'WebOS', '20W Sound'],
        img: 'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?auto=format&fit=crop&w=500&q=60'
    },
    {
        id: 2,
        name: 'Samsung 7 kg Fully-Automatic Front Loading Washing Machine',
        brand: 'Samsung',
        price: 29990,
        originalPrice: 35500,
        discount: '15% off',
        rating: 4.5,
        reviews: 3100,
        specs: ['Fully Automatic', '7 kg Capacity', 'Eco Bubble'],
        img: 'https://images.unsplash.com/photo-1626806775351-538af716f40c?auto=format&fit=crop&w=500&q=60'
    },
    {
        id: 3,
        ...
        rating: 4.2,
        reviews: 2400,
        specs: ['240 L', 'Triple Door', 'Frost Free'],
        img: 'https://images.unsplash.com/photo-1571175443880-49e1d58b794a?auto=format&fit=crop&w=500&q=60'
    },
    {
        id: 4,
        ...
        rating: 4.3,
        reviews: 4100,
        specs: ['1.5 Ton', '3 Star', 'Copper Condenser'],
        img: 'https://images.unsplash.com/photo-1614631446505-654dbd170427?auto=format&fit=crop&w=500&q=60'
    },
    {
        id: 5,
        ...
        rating: 4.4,
        reviews: 1200,
        specs: ['23 L', 'Convection', 'Touch Keypad'],
        img: 'https://images.unsplash.com/photo-1574269909862-7e1d70bb8078?auto=format&fit=crop&w=500&q=60'
    }
];
...
const Appliances = () => {
    ...
    const filteredData = appliancesData.filter(item => {
            ...
            <div className="mobiles-container">
                <aside className="mobiles-sidebar">
                    <div className="sidebar-header">
                        <h2>Filters</h2>
                        <button className="clear-btn" onClick={() => { setSelectedBrands([]); setMinPrice(0); setMaxPrice(100000); }}>Clear all</button>
                    </div>
                    ...
                    <div className="filter-section static">
                        <div className="filter-category-crumb">
                            ...
                            <div className="crumb-path">
                                <span className="light">Home & Kitchen</span>
                                <span className="bold">Appliances</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <FilterSection title="BRAND" defaultOpen={true}>
                        <div className="checkbox-group">
                            {['Samsung', 'LG', 'Whirlpool', 'Voltas', 'IFB', 'Sony'].map(brand => (
                ...
                <div className="mobiles-content">
                    <div className="mobiles-header">
                        <div>
                            <h1 className="mobiles-title">Appliances</h1>
                            <p className="mobiles-subtitle">Home & Kitchen Appliances</p>
                        </div>
