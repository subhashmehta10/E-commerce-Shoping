...
const beautyData = [
    {
        ...
        rating: 4.4,
        reviews: 5600,
        specs: ['Waterproof', 'Volume', 'Black'],
        img: 'https://images.unsplash.com/photo-1596462502278-27bfdd403cc2?auto=format&fit=crop&w=500&q=60'
    },
    {
        id: 2,
        name: 'Lakme Absolute Skin Gloss Gel',
        brand: 'Lakme',
        price: 450,
        originalPrice: 550,
        discount: '18% off',
        rating: 4.3,
        reviews: 2100,
        specs: ['Hydrating', 'Glossy Finish', '50g'],
        img: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&w=500&q=60'
    },
    {
        id: 3,
        ...
        rating: 4.6,
        reviews: 8900,
        specs: ['Vitamin E', 'Jojoba Oil', '300ml'],
        img: 'https://images.unsplash.com/photo-1611080626919-7cf5a9dbab5b?auto=format&fit=crop&w=500&q=60'
    },
    {
        id: 4,
        ...
        rating: 4.2,
        reviews: 1500,
        specs: ['Hair Color', 'No Ammonia', 'Long Lasting'],
        img: 'https://images.unsplash.com/photo-1608248598279-e99d160bfbc8?auto=format&fit=crop&w=500&q=60'
    },
    {
        id: 5,
        ...
        rating: 4.7,
        reviews: 890,
        specs: ['Matte Finish', 'Ruby Woo', 'Long wear'],
        img: 'https://images.unsplash.com/photo-1586495777744-4413f21062fa?auto=format&fit=crop&w=500&q=60'
    }
];
...
const Beauty = () => {
    ...
    const filteredData = beautyData.filter(item => {
            ...
            <div className="mobiles-container">
                <aside className="mobiles-sidebar">
                    <div className="sidebar-header">
                        <h2>Filters</h2>
                        <button className="clear-btn" onClick={() => { setSelectedBrands([]); setMinPrice(0); setMaxPrice(5000); }}>Clear all</button>
                    </div>
                    ...
                    <div className="filter-section static">
                        <div className="filter-category-crumb">
                            ...
                            <div className="crumb-path">
                                <span className="light">Beauty</span>
                                <span className="bold">All Products</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <FilterSection title="BRAND" defaultOpen={true}>
                        <div className="checkbox-group">
                            {['Lakme', 'Maybelline', 'Nivea', 'LOreal', 'MAC'].map(brand => (
                ...
                <div className="mobiles-content">
                    <div className="mobiles-header">
                        <div>
                            <h1 className="mobiles-title">Beauty</h1>
                            <p className="mobiles-subtitle">Makeup, Skincare & More</p>
                        </div>
